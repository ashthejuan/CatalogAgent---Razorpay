...
3. **`recurring` was never evaluated** — the 5th negotiable variable was ignored. Now recurring business grants a 2% margin concession; a recurring offer can tip effective margin negative when combined with other concessions. (`test_recurring_is_considered`.)
